...
namespace ThePetStop.Repository
{
    public class ApplicationDbContext : IdentityDbContext<ThePetStopApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ShoppingCart>()
                .HasOne<ThePetStopApplicationUser>(z => z.Owner)
